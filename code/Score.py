...
from code.Const import C_YELLOW, SCORE_POS, MENU_OPTION, C_WHITE, C_ORANGE, C_BLACK
...
class Score:
    def __init__(self, window):
        self.window = window
        self.surf = pygame.image.load('./assets/montain-score.png').convert_alpha()
        self.react = self.surf.get_rect(left=0, top=0)

    def save(self, game_mode:str, player_score: list[int]):
        pygame.mixer.music.load('./assets/sound.score.mp3')
